...
<head>
    ...
    <meta charset="UTF-8">
    <!-- Site Title -->
    <title>MGA Employee Voting System</title>
                ...
                <div class="row">
                    ...
                    <nav class="dope-navbar justify-content-between" id="dopeNav">
                        ...
                        <a class="nav-brand" href="index.html">
                            <img src="{{ asset('home/img/mlogo.png')}}" alt="">
                        </a>
                        ...
                        <div class="dope-menu">
                            ...
                            <div class="dopenav">
                                ...
                                @auth
                                <li>   
                                    <a class="primary-btn" href="{{ route('logout') }}" style="color: azure;text-decoration: none;" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"><i class="ti ti-user" ></i>
                                         Logout
                                     </a>
        ...
        <path class="st7" d="M2583.82,1115.86c0,0-1.66-8.98-1.76-13.11c-0.1-4.13-1.3-7.25-0.33-7.36s1.51,0.6,1.91,1.93
            s2.79,9.35,2.79,9.35l-0.77,7.94L2583.82,1115.86z"/>
                ...
                <div class="col-lg-5 col-md-5 about-right">
                    <h3>MGA Employee of the Month </h3>
                    <br>
