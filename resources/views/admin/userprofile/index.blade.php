                                ...
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-card card">
                                        <div class="card-body">
                                            ...
                                            <div class="mb-1">
                                                <strong class="mr-1">Role</strong>
                                                <p class="text-muted"><a href="#">{{$user->role}}</a></p>
                                            </div>
                                            <div class="mb-1">
                                                <strong class="mr-1">Department</strong>
                                                <p class="text-muted"><a href="#">{{$user->department_name}}</a></p>
                                            </div>
                                ...
                                <li class="timeline-item">
                                    ...
                                    <div class="timeline-card card">
                                        <div class="card-body">
                                           ...
                                           <form class="needs-validation" action="{{url('/admin/update-user/'. $user->id)}}" method="post" enctype="multipart/form-data" novalidate>
                                               @csrf
                                            ...
                                            <div class="form-row mb-3">
                                             ...
                                             <div class="form-row mb-3">
                                                <label>Role</label>
                                               <div class="input-group">
                                                <input type="text" class="form-control" value="{{$user->role}}" aria-label="comment" name="role">
                                            </div>
                                            </div>
                                             <div class="form-row mb-3">
                                                <label>Department</label>
                                               <div class="input-group">
                                                <input type="text" class="form-control" value="{{$user->department_name}}" aria-label="comment" name="department">
                                            </div>
                                            </div>
                                            <div class="form-row mb-3">
